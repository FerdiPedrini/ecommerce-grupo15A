...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(local);Database=DBVENTA;Integrated Security=true;Encrypt=False;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categorium>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C26E33E32");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FF28DF4D6");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48345B2E0C4");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107F7F4EFF6");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E8F0AEDB4");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1327D7714AA");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F765D971B49");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8565B47F1");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE8BD0C385");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6716FC10C");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614CA2585A3");

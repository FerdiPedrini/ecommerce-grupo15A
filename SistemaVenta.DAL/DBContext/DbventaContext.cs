...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CD2A7332D");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F3DDD4CBB");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48325959A30");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107AF48DDDA");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EA24B7079");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132CF9EE21A");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76BE845248");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8248414CB");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEB40EC509");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A670E4DEE2");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614D3DDCF08");
